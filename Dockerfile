...
RUN rm -rf /code && mkdir -p /var/lock/apache2 /var/run/apache2 /var/log/apache2 /code && chown -R www-data:www-data /var/lock/apache2 /var/run/apache2 /var/log/apache2 /code
...
RUN apt-get update && apt-get install -y mercurial streamripper python-pip
